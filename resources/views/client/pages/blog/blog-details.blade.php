                ...
                <div class="container">
                    ...
                    <article class="article">
                        ...
                        <div class="content">
                            ...
                            <img src="{{ asset('assets/images/blog/blog-inside-post.jpg') }}" class="img-fluid" alt="">
            ...
            <section id="blog-author" class="blog-author section">
                ...
                <div class="container">
                    <div class="author-container d-flex align-items-center">
                        <img src="{{ asset('assets/images/blog/blog-author.jpg') }}" class="rounded-circle flex-shrink-0" alt="">
                        <div>
                            <h4>Jane Smith</h4>
            ...
            <section id="blog-comments" class="blog-comments section">
                ...
                <div class="container">
                    ...
                    <div id="comment-1" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-1.jpg') }}" alt=""></div>
                            <div>
                    ...
                    <div id="comment-2" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-2.jpg') }}" alt=""></div>
                            <div>
                        ...
                        <div id="comment-reply-1" class="comment comment-reply">
                            <div class="d-flex">
                                <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-3.jpg') }}" alt=""></div>
                                <div>
                            ...
                            <div id="comment-reply-2" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-4.jpg') }}" alt=""></div>
                                    <div>
                    ...
                    <div id="comment-3" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-5.jpg') }}" alt=""></div>
                            <div>
                    ...
                    <div id="comment-4" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{ asset('assets/images/blog/comments-6.jpg')  }}" alt=""></div>
                            <div>
        ...
        <div class="col-lg-4 sidebar">
            ...
            <div class="widgets-container">
                ...
                <div class="recent-posts-widget widget-item">
                    ...
                    <div class="post-item">
                        <img src="{{ asset('assets/images/blog/blog-recent-1.jpg') }}" alt="" class="flex-shrink-0">
                        <div>
                    ...
                    <div class="post-item">
                        <img src="{{ asset('assets/images/blog/blog-recent-2.jpg') }}" alt="" class="flex-shrink-0">
                        <div>
                    ...
                    <div class="post-item">
                        <img src="{{ asset('assets/images/blog/blog-recent-3.jpg') }}" alt="" class="flex-shrink-0">
                        <div>
                    ...
                    <div class="post-item">
                        <img src="{{ asset('assets/images/blog/blog-recent-4.jpg') }}" alt="" class="flex-shrink-0">
                        <div>
                    ...
                    <div class="post-item">
                        <img src="{{ asset('assets/images/blog/blog-recent-5.jpg') }}" alt="" class="flex-shrink-0">
                        <div>
